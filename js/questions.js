...

{
    ...
    answers: [
        { text: "85kg 이상", score: 0 },
        { text: "80~84kg", score: 60 },
        { text: "75~79kg", score: 100 },
        { text: "70~74kg", score: 80 },
        { text: "65~69kg", score: 40 },
        { text: "64kg 이하", score: 20 }
    ]
},
...

{
    ...
    question: "덧니가 있다",
    question: "보조개가 있다",
    question: "귀를 움직일 수 있다",
    question: "얼굴/귀가 잘 빨개진다",
    question: "혀가 길다",
...

{
    ...
    question: "당신은 유예정과 함께 유명 맛집에 가게 되었습니다. 1시간을 넘게 기다려 겨우 들어온 식당, 직원은 매우 불친절합니다. 심지어 주문한 음식과 가격은 같지만 완전히 다른 음식이 나왔습니다.",
...

{
    ...
    question: "19. 당신은 몇 가지가 해당됩니까?",
    question: "사람을 때리거나 몸싸움을 한 적이 있다",
    question: "게임을 할 때나 친구를 만날 때 욕설을 사용한다",
    question: "주변에 쓰레기통이 없으면 길바닥에 쓰레기를 버린다",
    question: "무단횡단을 5번 이상 해본 적이 있다",
    question: "바람을 피운 적이 있다",
    question: "어른, 아이, 동물, 직원 등 약자를 막 대하는 편이다",
    question: "디시, 일베, 펨코, 루리웹 등의 커뮤니티를 자주 이용한다",
...

{
    ...
    question: "47. 당신은 아르바이트 경험이 있습니까? (한 알바에 3개월 이상 근로한 기준)",
...

{
    ...
    question: "문제 : 휴지 덩어리, 작은 플라스틱, 계란 껍데기, 바나나껍질, 종이는 일반 쓰레기이고 작은 생선 뼈, 요거트, 냉동과일, 파인애플, 상한 고기는 음식물 쓰레기이다. ",
...

{
    ...
    question: "58. 당신은 식사예절이 좋습니까? (정직하게 답변)",
...

{
    ...
    question: "보기 : 게스트하우스, 클럽, 헌팅포차, 양양서핑, 가평빠지, 유흥업소",
